        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-6 offset-md-1">
                    <h1><?= $movie->title ?></h1>
                    <p class="page-description">Alterar os dados do filme</p>
                    <form id="edit-movie-form" action="<?= $BASE_URL ?>/movie_process.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control space" id="title" name="title" placeholder="Titulo do filme" value="<?= $movie->title ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control space" id="length" name="length" placeholder="Duração do filme" value="<?= $movie->length ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control space" id="trailer" name="trailer" placeholder="Link do trailer do filme"  value="<?= $movie->trailer ?>">
                        </div>
                        <div class="form-group">
                            <label for="description">Descrição</label>                    
                            <textarea class="form-control space" name="description" id="description" rows="5" placeholder="Descrva o filme brevemente">
                                <?= $movie->description ?>
                            </textarea>
                        </div>
