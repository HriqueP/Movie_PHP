<?php
    ...
    class MovieDAO implements MovieDAOInterface{
        ...
        public function getLatestMMovies(){
            $movies = [];
        ...
        public function create(Movie $movie){
            ...
            //Mensagem de sucesso para adição de filme
        ...
        public function update(Movie $movie){
            ...
            //Mensagem de sucesso para update de filme
        ...
        public function destroy($id){
            ...
            //Mensagem de sucesso para remoção de filme
