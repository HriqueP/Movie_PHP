    ...
    <div id="main-container" class="container-fluid">
        <div class="row">
            ...
            <div class="offset-md-1 col-md-10" id="reviews-container">
                ...
                <!-- Verifica se habilita review de usuário ou não -->
                    ...
                    <div class="col-md-12" id="review-form-container">
                        ...
                        <form action="<?= $BASE_URL ?>/review_process.php" id="review-form" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="rating" id="rating" class="form-control space">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="review" id="review" rows="3" class="form-control space"></textarea>
                            </div>
                            <input type="submit" class="btn card-btn" value="Enviar Review">
                        </form>
                    </div>
                <?php endif; ?>
